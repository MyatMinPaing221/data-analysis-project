...
1. Clone this repo
2. Open `dashboard/NVIDIA_GPU_Dashboard.pbix` in Power BI Desktop
...
Built as part of a data analyst portfolio, focused on practicing star-schema modeling, DAX, and manager-level dashboard storytelling.
